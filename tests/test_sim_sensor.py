...
class TestSensorSimulation:
    ...
    def test_6_1_DataRate_NumSamplesIsOk_At10Hz(self):
        ''' Number of samples is correct at 10Hz '''
        usb.set_data_rate(10)
        usb.set_read_rate(10)
        assert len(usb.simulate_const_pattern(10, 10)) == 10

    def test_6_2_DataRate_NumSamplesIsOk_At100Hz(self):
        ''' Number of samples is correct at 100Hz '''
        usb.set_data_rate(100)
        usb.set_read_rate(100)
        assert len(usb.simulate_const_pattern(10, 10)) == 10
        
    def test_6_3_DataRate_NumSamplesIsOk_At1000Hz(self):
        ''' Number of samples is correct at 1000Hz '''
